...
public class Frag1 extends Fragment {
    ...
    public void setSenSorValue(String SenSorValue){  //센서값 받기
       ...
       if (Float.parseFloat(temp_dust) <= 30.0)
        ...
        if(face_detection_value == "person")
            ...
            jsonParse.execute("http://1.254.233.144:7776/info_noti.php");     // 이름과 생일을 db에서 불러오는 부분
    ...
    view = inflater.inflate(R.layout.frag1,container,false);
        ...
        final Frag1.JsonParse jsonParse = new Frag1.JsonParse();      // AsyncTask 생성
        jsonParse.execute("http://1.254.233.144:7776/info_load_birthday.php");     // 이름과 생일을 db에서 불러오는 부분
    ...
    public class JsonParse extends AsyncTask<String, Void, String> {   // DB날짜 불러오는  클래스
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                switch (url){
                    case ("http://1.254.233.144:7776/info_load_birthday.php"):
                        ...
                        break;
                    case ("http://1.254.233.144:7776/info_noti.php"):
